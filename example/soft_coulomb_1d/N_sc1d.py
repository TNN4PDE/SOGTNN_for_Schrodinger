...
for e in range(phase1_epochs):
    ...
    if (e + 1) % print_every == 0:
        ...
        print('{:<9}{:<25}'.format('epoch = ', e + 1))
        print('{:<9}{:<25}'.format('loss = ', current_loss))
        print('{:<9}{:<25}'.format('Kinetic energy = ', (T / M).item()))
        print('{:<9}{:<25}'.format('Single electorn Potential energy = ', (V_ie / M).item()))
        print('{:<9}{:<25}'.format('Electron-electorn Potential energy = ', (V_ee / M).item()))
endtime = time.time()
print('*' * 40)
print('Done!')
