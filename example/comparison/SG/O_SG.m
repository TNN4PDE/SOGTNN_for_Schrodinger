% =========================================================================
% Sparse Grid Spectral Element Method for 1D Oxygen Atom (Soft-Coulomb)
% System: 8 Electrons (4 Spin-Up, 4 Spin-Down, Balanced State)
...
clear;
%% 1. Parameters
Z = 8;              % Nuclear charge for Oxygen
rc = 20;            % Cutoff radius
max_mode = 6;       % 1D Basis maximum order
...
fprintf('Initializing Oxygen Atom SG-CI Solver (8-Electron Extreme Speed)...\n');
...
p = size(E_kl,1);
%% 3. Basis Construction (Fast Vectorized SG-CI for 8 Electrons)
fprintf('Constructing 8D Basis Space (Vectorized Divide & Conquer)...\n');
tic;
range_modes = -max_mode:max_mode;
% --- Step 1: Generate Spin-Up combinations (4 particles) ---
...
% --- Step 2: Generate Spin-Down combinations (4 particles) ---
dn_combs = nchoosek(range_modes, 4);
...
indices_buffer = zeros(est_states, 8);
count = 0;
for i = 1:N_up
    ...
    if num_matches > 0
        if count + num_matches > size(indices_buffer, 1)
            indices_buffer = [indices_buffer; zeros(est_states, 8)];
        end
...
fprintf('Total SG DoFs (Oxygen, 8-Electron): %d (Generated in %.3f sec)\n', N_states, toc);
...
for ii = 1:N
    ...
    for jj = 1:N
        ...
        if k1 == k2, if k1 == 0, T1_raw(i,j) = 2; else, T1_raw(i,j) = 4*(2*absidx(k1) + 1); end
        else, T1_raw(i,j) = 0; end
    end
end
...
fprintf('Assembling Global Matrices (4x4 UP / 4x4 DOWN Fully Evaluated)...\n');
...
% Tuned chunk size for 8e optimal VRAM usage (Huge memory consumption due to 4x4 complexity)
mem_per_row = N_states * 8 * 250; 
...
% 3x3 Cofactor generator helper (inlined for GPU performance)
...
for k = 1:num_chunks
    ...
    % Down-Spin indices (s, t, u, w)
    g_s_bra = G_indices(current_rows, 5) + offset; g_t_bra = G_indices(current_rows, 6) + offset; 
    g_u_bra = G_indices(current_rows, 7) + offset; g_w_bra = G_indices(current_rows, 8) + offset;
    g_s_ket = G_indices(:, 5) + offset; g_t_ket = G_indices(:, 6) + offset; 
    g_u_ket = G_indices(:, 7) + offset; g_w_ket = G_indices(:, 8) + offset;
    
    get_1D = @(Mat, br, kt) Mat(br + (kt.' - 1) * N);
    
    % --- UP Spin: 4x4 Matrices & 16 Cofactors ---
    ...
    Dup_11 =  cof_3x3(Mup_22, Mup_23, Mup_24, Mup_32, Mup_33, Mup_34, Mup_42, Mup_43, Mup_44); Dup_12 = -cof_3x3(Mup_21, Mup_23, Mup_24, Mup_31, Mup_33, Mup_34, Mup_41, Mup_43, Mup_44);
    Dup_13 =  cof_3x3(Mup_21, Mup_22, Mup_24, Mup_31, Mup_32, Mup_34, Mup_41, Mup_42, Mup_44); Dup_14 = -cof_3x3(Mup_21, Mup_22, Mup_23, Mup_31, Mup_32, Mup_33, Mup_41, Mup_42, Mup_43);
    Dup_21 = -cof_3x3(Mup_12, Mup_13, Mup_14, Mup_32, Mup_33, Mup_34, Mup_42, Mup_43, Mup_44); Dup_22 =  cof_3x3(Mup_11, Mup_13, Mup_14, Mup_31, Mup_33, Mup_34, Mup_41, Mup_43, Mup_44);
    Dup_23 = -cof_3x3(Mup_11, Mup_12, Mup_14, Mup_31, Mup_32, Mup_34, Mup_41, Mup_42, Mup_44); Dup_24 =  cof_3x3(Mup_11, Mup_12, Mup_13, Mup_31, Mup_32, Mup_33, Mup_41, Mup_42, Mup_43);
    Dup_31 =  cof_3x3(Mup_12, Mup_13, Mup_14, Mup_22, Mup_23, Mup_24, Mup_42, Mup_43, Mup_44); Dup_32 = -cof_3x3(Mup_11, Mup_13, Mup_14, Mup_21, Mup_23, Mup_24, Mup_41, Mup_43, Mup_44);
    Dup_33 =  cof_3x3(Mup_11, Mup_12, Mup_14, Mup_21, Mup_22, Mup_24, Mup_41, Mup_42, Mup_44); Dup_34 = -cof_3x3(Mup_11, Mup_12, Mup_13, Mup_21, Mup_22, Mup_23, Mup_41, Mup_42, Mup_43);
    Dup_41 = -cof_3x3(Mup_12, Mup_13, Mup_14, Mup_22, Mup_23, Mup_24, Mup_32, Mup_33, Mup_34); Dup_42 =  cof_3x3(Mup_11, Mup_13, Mup_14, Mup_21, Mup_23, Mup_24, Mup_31, Mup_33, Mup_34);
    Dup_43 = -cof_3x3(Mup_11, Mup_12, Mup_14, Mup_21, Mup_22, Mup_24, Mup_31, Mup_32, Mup_34); Dup_44 =  cof_3x3(Mup_11, Mup_12, Mup_13, Mup_21, Mup_22, Mup_23, Mup_31, Mup_32, Mup_33);
    
    M_up = Mup_11.*Dup_11 + Mup_12.*Dup_12 + Mup_13.*Dup_13 + Mup_14.*Dup_14;
    
    % --- DOWN Spin: 4x4 Matrices & 16 Cofactors ---
    Mdn_11 = get_1D(G_M1, g_s_bra, g_s_ket); Mdn_12 = get_1D(G_M1, g_s_bra, g_t_ket); Mdn_13 = get_1D(G_M1, g_s_bra, g_u_ket); Mdn_14 = get_1D(G_M1, g_s_bra, g_w_ket);
    Mdn_21 = get_1D(G_M1, g_t_bra, g_s_ket); Mdn_22 = get_1D(G_M1, g_t_bra, g_t_ket); Mdn_23 = get_1D(G_M1, g_t_bra, g_u_ket); Mdn_24 = get_1D(G_M1, g_t_bra, g_w_ket);
    Mdn_31 = get_1D(G_M1, g_u_bra, g_s_ket); Mdn_32 = get_1D(G_M1, g_u_bra, g_t_ket); Mdn_33 = get_1D(G_M1, g_u_bra, g_u_ket); Mdn_34 = get_1D(G_M1, g_u_bra, g_w_ket);
    Mdn_41 = get_1D(G_M1, g_w_bra, g_s_ket); Mdn_42 = get_1D(G_M1, g_w_bra, g_t_ket); Mdn_43 = get_1D(G_M1, g_w_bra, g_u_ket); Mdn_44 = get_1D(G_M1, g_w_bra, g_w_ket);
    
    Ddn_11 =  cof_3x3(Mdn_22, Mdn_23, Mdn_24, Mdn_32, Mdn_33, Mdn_34, Mdn_42, Mdn_43, Mdn_44); Ddn_12 = -cof_3x3(Mdn_21, Mdn_23, Mdn_24, Mdn_31, Mdn_33, Mdn_34, Mdn_41, Mdn_43, Mdn_44);
    Ddn_13 =  cof_3x3(Mdn_21, Mdn_22, Mdn_24, Mdn_31, Mdn_32, Mdn_34, Mdn_41, Mdn_42, Mdn_44); Ddn_14 = -cof_3x3(Mdn_21, Mdn_22, Mdn_23, Mdn_31, Mdn_32, Mdn_33, Mdn_41, Mdn_42, Mdn_43);
    Ddn_21 = -cof_3x3(Mdn_12, Mdn_13, Mdn_14, Mdn_32, Mdn_33, Mdn_34, Mdn_42, Mdn_43, Mdn_44); Ddn_22 =  cof_3x3(Mdn_11, Mdn_13, Mdn_14, Mdn_31, Mdn_33, Mdn_34, Mdn_41, Mdn_43, Mdn_44);
    Ddn_23 = -cof_3x3(Mdn_11, Mdn_12, Mdn_14, Mdn_31, Mdn_32, Mdn_34, Mdn_41, Mdn_42, Mdn_44); Ddn_24 =  cof_3x3(Mdn_11, Mdn_12, Mdn_13, Mdn_31, Mdn_32, Mdn_33, Mdn_41, Mdn_42, Mdn_43);
    Ddn_31 =  cof_3x3(Mdn_12, Mdn_13, Mdn_14, Mdn_22, Mdn_23, Mdn_24, Mdn_42, Mdn_43, Mdn_44); Ddn_32 = -cof_3x3(Mdn_11, Mdn_13, Mdn_14, Mdn_21, Mdn_23, Mdn_24, Mdn_41, Mdn_43, Mdn_44);
    Ddn_33 =  cof_3x3(Mdn_11, Mdn_12, Mdn_14, Mdn_21, Mdn_22, Mdn_24, Mdn_41, Mdn_42, Mdn_44); Ddn_34 = -cof_3x3(Mdn_11, Mdn_12, Mdn_13, Mdn_21, Mdn_22, Mdn_23, Mdn_41, Mdn_42, Mdn_43);
    Ddn_41 = -cof_3x3(Mdn_12, Mdn_13, Mdn_14, Mdn_22, Mdn_23, Mdn_24, Mdn_32, Mdn_33, Mdn_34); Ddn_42 =  cof_3x3(Mdn_11, Mdn_13, Mdn_14, Mdn_21, Mdn_23, Mdn_24, Mdn_31, Mdn_33, Mdn_34);
    Ddn_43 = -cof_3x3(Mdn_11, Mdn_12, Mdn_14, Mdn_21, Mdn_22, Mdn_24, Mdn_31, Mdn_32, Mdn_34); Ddn_44 =  cof_3x3(Mdn_11, Mdn_12, Mdn_13, Mdn_21, Mdn_22, Mdn_23, Mdn_31, Mdn_32, Mdn_33);
    
    M_dn = Mdn_11.*Ddn_11 + Mdn_12.*Ddn_12 + Mdn_13.*Ddn_13 + Mdn_14.*Ddn_14;
    
    % 1. Mass
    Mg_local = M_up .* M_dn;
    % NOTE: Do NOT clear Mup_ij / Mdn_ij yet, they are needed for Gamma_up/dn
    ...
    Tdn_11 = get_1D(G_T1, g_s_bra, g_s_ket); Tdn_12 = get_1D(G_T1, g_s_bra, g_t_ket); Tdn_13 = get_1D(G_T1, g_s_bra, g_u_ket); Tdn_14 = get_1D(G_T1, g_s_bra, g_w_ket);
    Tdn_21 = get_1D(G_T1, g_t_bra, g_s_ket); Tdn_22 = get_1D(G_T1, g_t_bra, g_t_ket); Tdn_23 = get_1D(G_T1, g_t_bra, g_u_ket); Tdn_24 = get_1D(G_T1, g_t_bra, g_w_ket);
    Tdn_31 = get_1D(G_T1, g_u_bra, g_s_ket); Tdn_32 = get_1D(G_T1, g_u_bra, g_t_ket); Tdn_33 = get_1D(G_T1, g_u_bra, g_u_ket); Tdn_34 = get_1D(G_T1, g_u_bra, g_w_ket);
    Tdn_41 = get_1D(G_T1, g_w_bra, g_s_ket); Tdn_42 = get_1D(G_T1, g_w_bra, g_t_ket); Tdn_43 = get_1D(G_T1, g_w_bra, g_u_ket); Tdn_44 = get_1D(G_T1, g_w_bra, g_w_ket);
    T_dn = Tdn_11.*Ddn_11 + Tdn_12.*Ddn_12 + Tdn_13.*Ddn_13 + Tdn_14.*Ddn_14 ...
         + Tdn_21.*Ddn_21 + Tdn_22.*Ddn_22 + Tdn_23.*Ddn_23 + Tdn_24.*Ddn_24 ...
         + Tdn_31.*Ddn_31 + Tdn_32.*Ddn_32 + Tdn_33.*Ddn_33 + Tdn_34.*Ddn_34 ...
         + Tdn_41.*Ddn_41 + Tdn_42.*Ddn_42 + Tdn_43.*Ddn_43 + Tdn_44.*Ddn_44;
    clear Tdn_11 Tdn_12 Tdn_13 Tdn_14 Tdn_21 Tdn_22 Tdn_23 Tdn_24 Tdn_31 Tdn_32 Tdn_33 Tdn_34 Tdn_41 Tdn_42 Tdn_43 Tdn_44;
    ...
    Vsdn_11 = get_1D(G_Vs, g_s_bra, g_s_ket); Vsdn_12 = get_1D(G_Vs, g_s_bra, g_t_ket); Vsdn_13 = get_1D(G_Vs, g_s_bra, g_u_ket); Vsdn_14 = get_1D(G_Vs, g_s_bra, g_w_ket);
    Vsdn_21 = get_1D(G_Vs, g_t_bra, g_s_ket); Vsdn_22 = get_1D(G_Vs, g_t_bra, g_t_ket); Vsdn_23 = get_1D(G_Vs, g_t_bra, g_u_ket); Vsdn_24 = get_1D(G_Vs, g_t_bra, g_w_ket);
    Vsdn_31 = get_1D(G_Vs, g_u_bra, g_s_ket); Vsdn_32 = get_1D(G_Vs, g_u_bra, g_t_ket); Vsdn_33 = get_1D(G_Vs, g_u_bra, g_u_ket); Vsdn_34 = get_1D(G_Vs, g_u_bra, g_w_ket);
    Vsdn_41 = get_1D(G_Vs, g_w_bra, g_s_ket); Vsdn_42 = get_1D(G_Vs, g_w_bra, g_t_ket); Vsdn_43 = get_1D(G_Vs, g_w_bra, g_u_ket); Vsdn_44 = get_1D(G_Vs, g_w_bra, g_w_ket);
    Vs_dn = Vsdn_11.*Ddn_11 + Vsdn_12.*Ddn_12 + Vsdn_13.*Ddn_13 + Vsdn_14.*Ddn_14 ...
          + Vsdn_21.*Ddn_21 + Vsdn_22.*Ddn_22 + Vsdn_23.*Ddn_23 + Vsdn_24.*Ddn_24 ...
          + Vsdn_31.*Ddn_31 + Vsdn_32.*Ddn_32 + Vsdn_33.*Ddn_33 + Vsdn_34.*Ddn_34 ...
          + Vsdn_41.*Ddn_41 + Vsdn_42.*Ddn_42 + Vsdn_43.*Ddn_43 + Vsdn_44.*Ddn_44;
    clear Vsdn_11 Vsdn_12 Vsdn_13 Vsdn_14 Vsdn_21 Vsdn_22 Vsdn_23 Vsdn_24 Vsdn_31 Vsdn_32 Vsdn_33 Vsdn_34 Vsdn_41 Vsdn_42 Vsdn_43 Vsdn_44;
          
    Vs_total = (Vs_up .* M_dn + Vs_dn .* M_up) * (-Z / rc);
    clear Vs_up Vs_dn;
    
    % 4. Electron-Electron Repulsion (V_D)
    % --- Universal 2-Body Cofactor Generator ---
    Mup_cell = {Mup_11, Mup_12, Mup_13, Mup_14; Mup_21, Mup_22, Mup_23, Mup_24; Mup_31, Mup_32, Mup_33, Mup_34; Mup_41, Mup_42, Mup_43, Mup_44};
    Mdn_cell = {Mdn_11, Mdn_12, Mdn_13, Mdn_14; Mdn_21, Mdn_22, Mdn_23, Mdn_24; Mdn_31, Mdn_32, Mdn_33, Mdn_34; Mdn_41, Mdn_42, Mdn_43, Mdn_44};
    
    rem_idx = [3, 4; 2, 4; 2, 3; 1, 4; 1, 3; 1, 2];
    sgn_base = [3, 4, 5, 5, 6, 7];
    Gamma_up = cell(6,6); Gamma_dn = cell(6,6);
    
    for I=1:6
        r1 = rem_idx(I,1); r2 = rem_idx(I,2);
        for J=1:6
            c1 = rem_idx(J,1); c2 = rem_idx(J,2);
            sgn = (-1)^(sgn_base(I) + sgn_base(J));
            Gamma_up{I,J} = sgn .* (Mup_cell{r1,c1}.*Mup_cell{r2,c2} - Mup_cell{r1,c2}.*Mup_cell{r2,c1});
            Gamma_dn{I,J} = sgn .* (Mdn_cell{r1,c1}.*Mdn_cell{r2,c2} - Mdn_cell{r1,c2}.*Mdn_cell{r2,c1});
        end
    end
    clear Mup_cell Mdn_cell Mup_11 Mup_12 Mup_13 Mup_14 Mup_21 Mup_22 Mup_23 Mup_24 Mup_31 Mup_32 Mup_33 Mup_34 Mup_41 Mup_42 Mup_43 Mup_44;
    clear Mdn_11 Mdn_12 Mdn_13 Mdn_14 Mdn_21 Mdn_22 Mdn_23 Mdn_24 Mdn_31 Mdn_32 Mdn_33 Mdn_34 Mdn_41 Mdn_42 Mdn_43 Mdn_44;
    ...
    for I = 1:6
        for J = 1:6
            ...
            vd_up = G_VD_raw(i1 + (i2 - 1)*N2) - G_VD_raw(i3 + (i4 - 1)*N2) - G_VD_raw(i4 + (i3 - 1)*N2) + G_VD_raw(i2 + (i1 - 1)*N2);
            Vee_up_up = Vee_up_up + vd_up .* Gamma_up{I, J};
        end
    end
    Vee_up_up = Vee_up_up .* M_dn;
    clear Gamma_up P1_up P2_up Q1_up Q2_up;
    
    % 4b. Same-Spin (DOWN-DOWN) 
    P1_dn = {g_s_bra, g_s_bra, g_s_bra, g_t_bra, g_t_bra, g_u_bra}; 
    P2_dn = {g_t_bra, g_u_bra, g_w_bra, g_u_bra, g_w_bra, g_w_bra};
    Q1_dn = {g_s_ket, g_s_ket, g_s_ket, g_t_ket, g_t_ket, g_u_ket}; 
    Q2_dn = {g_t_ket, g_u_ket, g_w_ket, g_u_ket, g_w_ket, g_w_ket};
    ...
    for I = 1:6
        for J = 1:6
            ...
            vd_dn = G_VD_raw(i1 + (i2 - 1)*N2) - G_VD_raw(i3 + (i4 - 1)*N2) - G_VD_raw(i4 + (i3 - 1)*N2) + G_VD_raw(i2 + (i1 - 1)*N2);
            Vee_dn_dn = Vee_dn_dn + vd_dn .* Gamma_dn{I, J};
        end
    end
    Vee_dn_dn = Vee_dn_dn .* M_up;
    clear Gamma_dn P1_dn P2_dn Q1_dn Q2_dn M_up M_dn;
    
    % 4c. Cross-Spin (UP-DOWN) - 256 terms perfectly unrolled!
    p_up = {g_m_bra, g_n_bra, g_l_bra, g_v_bra}; q_up = {g_m_ket, g_n_ket, g_l_ket, g_v_ket};
    p_dn = {g_s_bra, g_t_bra, g_u_bra, g_w_bra}; q_dn = {g_s_ket, g_t_ket, g_u_ket, g_w_ket};
    ...
    D_dn_cell = {Ddn_11, Ddn_12, Ddn_13, Ddn_14; Ddn_21, Ddn_22, Ddn_23, Ddn_24; Ddn_31, Ddn_32, Ddn_33, Ddn_34; Ddn_41, Ddn_42, Ddn_43, Ddn_44};
    ...
    clear D_up_cell D_dn_cell Dup_11 Dup_12 Dup_13 Dup_14 Dup_21 Dup_22 Dup_23 Dup_24 Dup_31 Dup_32 Dup_33 Dup_34 Dup_41 Dup_42 Dup_43 Dup_44;
    clear Ddn_11 Ddn_12 Ddn_13 Ddn_14 Ddn_21 Ddn_22 Ddn_23 Ddn_24 Ddn_31 Ddn_32 Ddn_33 Ddn_34 Ddn_41 Ddn_42 Ddn_43 Ddn_44 p_up q_up p_dn q_dn;
