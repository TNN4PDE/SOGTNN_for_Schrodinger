...
CKPTDIR="${ROOT}/checkpoints_ferminet_x64_atoms/Be_singlet"
...
nohup python -u -m ferminet.main \
  ...
  > "${LOGDIR}/train_Be_singlet.log" 2>&1 &

echo "Launched Be_singlet on physical GPU ${GPU_ID}."
echo "Log: ${LOGDIR}/train_Be_singlet.log"
