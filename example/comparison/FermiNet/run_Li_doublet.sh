...
CKPTDIR="${ROOT}/checkpoints_ferminet_x64_atoms/Li_doublet"
...
nohup python -u -m ferminet.main \
  ...
  --config.system.spin_polarisation 1 \
  ...
  > "${LOGDIR}/train_Li_doublet.log" 2>&1 &

echo "Launched Li_doublet on physical GPU ${GPU_ID}."
echo "Log: ${LOGDIR}/train_Li_doublet.log"
