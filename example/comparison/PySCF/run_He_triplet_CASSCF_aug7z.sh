...
SCRIPT=${SCRIPT:-${SCRIPT_DIR}/He_triplet_CASSCF_aug7z.py}
...
# Same grid as the singlet for a direct state-to-state comparison.
read -r -a NCAS <<< "${NCAS_LIST:-96 112 128 144 160}"
...
LOG=${LOG:-He_triplet_aug7z_${STAMP}.log}
PREFIX=${PREFIX:-He_triplet_CASSCF_aug7z}
