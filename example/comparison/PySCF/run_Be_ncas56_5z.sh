...
#
# Usage:
#   ./run_Be_ncas56_5z.sh start
#   ./run_Be_ncas56_5z.sh status
#   ./run_Be_ncas56_5z.sh monitor
#   ./run_Be_ncas56_5z.sh logs
#   ./run_Be_ncas56_5z.sh stop
...
CPU_LIST=${CPU_LIST:-8-15}
THREADS=${THREADS:-8}
MEMORY_MB=${MEMORY_MB:-32000}
MAX_MACRO=${MAX_MACRO:-100}
NICE_LEVEL=${NICE_LEVEL:-5}

STATE_DIR=${STATE_DIR:-${SCRIPT_DIR}/.be_ncas56_5z_state}
